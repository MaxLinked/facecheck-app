...
export default function TabBar() {
  ...
  return (
    <nav className="absolute bottom-0 left-0 right-0 pb-5 pt-2 px-16 flex items-center justify-center">
      <div className="flex items-center gap-10 px-8 py-2 bg-white/70 backdrop-blur-xl rounded-full shadow-lg border border-black/5">
        {tabs.map((tab) => {
